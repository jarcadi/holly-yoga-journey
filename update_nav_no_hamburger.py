...
# Read the updated navigation menu content without hamburger icon
with open('/home/jarcadi/.openclaw/workspace/yoga-site/updated-nav-no-hamburger.html', 'r') as f:
    updated_nav = f.read()
...
print('Navigation menu updated successfully in index.html without hamburger icon')
