...
# Read the updated navigation menu content
with open('/home/jarcadi/.openclaw/workspace/yoga-site/updated-nav-menu.html', 'r') as f:
    updated_nav = f.read()
...
print('Navigation menu updated successfully in index.html')
